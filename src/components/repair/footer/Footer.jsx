...
import ServicesFeatures from '../servicesFeatures/ServicesFeatures.jsx';

export default function Footer() {
	return (
		<footer className="bg-dark-bg">
			<ServicesFeatures />
			<div className="container text-sm w-full px-3 py-6 sm:py-8 mx-auto  text-gray-300">
				<MobileFooterIcon />
				<div className=" w-full flex justify-center md:justify-between items-start gap-3 pb-6">
					<FooterContactInfo />
					<FooterServices />
					<QuickLinks />
					<StoreSocialMedia />
