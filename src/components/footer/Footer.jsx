...
export default function Footer() {
   return (
       <footer className="container w-full px-3 py-6 sm:py-8 mx-auto bg-dark-bg text-gray-300">
          <MobileFooterIcon/>
          ...
          <div className="w-full text-center border-t border-brand-gray pt-6">
             <p className="max-w-2/3 mx-auto">تمامی حقوق برای فون داک محفوظ است.  &copy; 2026</p>
          </div>
       </footer>
   )
}
